...
exports['default'] = {
  general: function(api){
    ...
    return {
      ...
      serverToken: '72edc440-86e0-11e6-bb2d-0390868d1cbd',
      // The welcome message seen by TCP and webSocket clients upon connection
      welcomeMessage: 'Hello! Welcome to the leng56 api',
      ...
      filteredParams: ['password', 'passwordHash', 'passwordSalt', 'csrfToken'],
  ...
  general: function(api){
    return {
      developmentMode: false,
        paths: {
            public: [__dirname + '/../target/public']
        }
    };
  }
};
